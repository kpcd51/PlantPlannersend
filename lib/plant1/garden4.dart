                          ...
                          if (snapshot.connectionState == ConnectionState.waiting) {
                            ...
                            return Stack(
                              children: [
                                ...
                                Padding(
                                  padding:
                                      const EdgeInsets.fromLTRB(90, 70, 0, 0),
                                  child: Text(
                                    "Plan Your",
                                    style: TextStyle(
                                ...
                                Padding(
                                  padding:
                                      const EdgeInsets.fromLTRB(100, 120, 0, 0),
                                  child: Text(
                                    "Garden!!",
                                    style: TextStyle(
                                      color: Color(0xff4E514A),
                                ...
                                Padding(
                                  padding:
                                      const EdgeInsets.fromLTRB(230, 600, 0, 0),
                                  child: IconButton(
                                ...
                                Padding(
                                  padding:
                                      const EdgeInsets.fromLTRB(50, 580, 0, 0),
                                  child: IconButton(
                                ...
                                Padding(
                                  padding:
                                      const EdgeInsets.fromLTRB(50, 690, 0, 0),
                                  child: Text(
                                    "ตารางรดน้ำ",
                                    style: TextStyle(
                                      color: Color(0xff4E514A),
                                ...
                                Padding(
                                  padding:
                                      const EdgeInsets.fromLTRB(230, 690, 0, 0),
                                  child: Text(
                                    "เพิ่มต้นไม้",
                                    style: TextStyle(
                                      color: Color(0xff4E514A),
                                ...
                                Padding(
                                  padding:
                                      const EdgeInsets.fromLTRB(0, 180, 0, 0),
                                  child: Container(
                                    height: 400,
